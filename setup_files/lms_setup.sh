...
wget https://downloads.lms-community.org/nightly/lyrionmusicserver_9.0.0~1731963391_all.deb &>/dev/null

echo -e "${CHECKMARK} \e[1;92m Installing Logitech Media Server... \e[0m"
sudo apt install -y ./lyrionmusicserver_9.0.0~1731963391_all.deb  &>/dev/null
